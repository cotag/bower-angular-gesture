...
Instead of only dealing with events that fall on the objecs, pointers are captured so events continue to be processed by the element they originally touched.

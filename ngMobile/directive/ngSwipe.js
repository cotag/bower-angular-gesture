(function(angular) {
  ...
  angular.module('ngMobile')
    ...
    /**
     * @ngdoc service
     * @name ngMobile.service:$mobileSwipe
     *
     * @description
     * An alias for $mobile that ensures swipe detection functionality is available.
     *  Adds bindings for `swipe`, `swipeleft`, `swiperight`, `swipeup` and
     *  `swipedown` to $mobile
     */
    .factory('$mobileSwipe', ['$mobile', function($mobile) {
      $mobile.register({
        name: 'swipe',
        index: 40,
        defaults: {
     ...
     */
    .directive('ngSwipe', ['$parse', '$mobileSwipe', function($parse, $mobile) {
     ...
     */
    .directive('ngSwipeRight', ['$parse', '$mobileSwipe', function($parse, $mobile) {
      return function(scope, element, attr) {
     ...
     */
    .directive('ngSwipeLeft', ['$parse', '$mobileSwipe', function($parse, $mobile) {
      return function(scope, element, attr) {
     ...
     */
    .directive('ngSwipeUp', ['$parse', '$mobileSwipe', function($parse, $mobile) {
      return function(scope, element, attr) {
     ...
     */
    .directive('ngSwipeDown', ['$parse', '$mobileSwipe', function($parse, $mobile) {
      return function(scope, element, attr) {
